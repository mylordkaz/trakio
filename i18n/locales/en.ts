export default {
  ...
  menu: {
    ...
    bluetoothPermissionDenied: 'Bluetooth access is denied. Allow Bluetooth for Trakio in Settings.',
    bluetoothOff: 'Bluetooth is turned off. Turn it on to scan for devices.',
