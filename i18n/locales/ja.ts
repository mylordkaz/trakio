export default {
  ...
  circuits: {
    ...
    requestCircuit: 'サーキットをリクエスト',
    requestSearch: '「%{name}」をリクエスト',
    requestTitle: 'サーキットをリクエスト',
    requestQuestion: 'Trakioに追加してほしいサーキットは？',
    requestPlaceholder: 'サーキット名',
    requestSend: 'リクエストを送信',
    requestSending: '送信中...',
    requestSuccessTitle: 'リクエストを受け付けました',
    requestSuccessMessage: 'ありがとうございます。「%{name}」をリクエスト一覧に追加しました。',
    requestFailed: 'リクエストを送信できませんでした。通信状況を確認してもう一度お試しください。',
  ...
  sessions: {
    ...
    exportChooseFormat: 'このセッションをタイムシートとしてエクスポート',
    exportPdf: 'PDFタイムシート',
    exportCsv: 'CSV',
    exportFailed: 'このセッションをエクスポートできませんでした。',
    timeSheetTitle: 'ラップタイムシート',
    timeSheetLap: 'Lap',
  ...
  recording: {
    ...
    currentLap: '現在のラップ',
    gpsSignalLost: 'GPS信号ロスト — 再取得待ち',
    gpsDegraded: 'GPS精度低下 — 不良ポイントを除外中',
    recordingInterrupted: '記録が中断されました — 走行ラインに欠落の可能性',
  },
  profile: {
    title: 'プロフィール',
    subtitle: 'ドライバー情報',
  ...
  menu: {
    ...
    bluetoothPermissionDenied: 'Bluetoothの使用が許可されていません。設定でTrakioのBluetoothを許可してください。',
    bluetoothOff: 'BluetoothがOFFになっています。ONにしてからスキャンしてください。',
    openSettings: '設定を開く',
    removeDevice: '解除',
    connecting: '接続中...',
    tapToSelect: 'デバイスをタップして選択',
    preferences: '設定',
    appearance: '外観',
    language: '言語',
    english: 'English',
  ...
  feedback: {
    ...
    successMessage: 'Trakioの改善にご協力いただきありがとうございます。',
  ...
  telemetry: {
    ...
    gpsLost: '信号ロスト',
    gpsDegradedShort: '精度低下',
    gpsSignal: 'GPS信号',
    gpsSource: 'GPS ソース',
    phoneGps: '内蔵GPS',
    satellites: '衛星数',
    deviceBattery: 'デバイスバッテリー',
    strong: '強い',
    weak: '弱い',
    searching: '探索中',
    blocked: 'ブロック中',
